...
if __name__ == "__main__":
	...
	parser.add_argument("-n", type=str, metavar="normIntegralName", dest="normIntegralName", default="integralFile", help="normIntegralFile")
	parser.add_argument("-a", type=str, metavar="acceptanceIntegralName", dest="accIntegralName", default="integralFile", help="acceptanceIntegralFile")
...
# 	parser.add_argument("-w", type=str, metavar="path", dest="weightsFileName", default="", help="path to MC weight file for de-weighting (default: none)")
	...
	ampFileList = fileManager.getAmpFilePaths()
	if not ampFileList:
