...
if __name__ == "__main__":
	...
	ampIntMatrixBenchmark = pyRootPwa.core.getFromTDirectory(integralBenchmarkFile, "integral")
	ampIntMatrixCreated   = pyRootPwa.core.getFromTDirectory(integralCreatedFile, "integral")
